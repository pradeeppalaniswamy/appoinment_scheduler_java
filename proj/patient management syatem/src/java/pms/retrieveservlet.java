...
public class retrieveservlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
     ...
     PreparedStatement pre1 = connn.prepareStatement("select imgdescription,photo from scanimages  where patientid='"+patid+"'order by image_id limit 0,1 ;");
...
while(rs1.next())   
 {byte[] bytearray1 = new byte[4096];  
  ...
  connn.close();  
            ...
            out.print(message);
            out.println("<body>");
            out.println("<h1>Servlet retrieveservlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
