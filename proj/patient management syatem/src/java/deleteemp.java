...
public class deleteemp extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       String eid=request.getParameter("Docdetailadmin");
        Doctor D=new Doctor();
int succ=D.delete(eid);
if(succ>0)
         {
         
   request.setAttribute("message4","employee deleted Successfully");
request.getRequestDispatcher("welcomeadmin.jsp").forward(request,response);      

         }
         else
         {
   request.setAttribute("message4","Unablle to delete !please clear appointments  Try Again");
